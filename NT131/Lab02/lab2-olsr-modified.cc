...
//
  ...
  // For a range
  wifiPhy.Set ("TxPowerStart", DoubleValue(13));
  wifiPhy.Set ("TxPowerEnd", DoubleValue(13));
  ...
  positionAlloc ->Add(Vector(450, -150, 0)); // node3
  ...
  // Trace devices (pcap)
  wifiPhy.EnablePcap ("lab2-olsr", devices);
  ...
  Simulator::Schedule(Seconds(30), &stopMover);
